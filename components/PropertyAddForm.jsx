    ...
    <form action="/api/properties" method="POST" encType="multipart/form-data">
      ...
      <div className="mb-4">
        ...
        <input
          ...
          placeholder="eg. Beautiful Apartment In Gauhati"
          required
          value={fields.name}
          onChange={handleChange}
        />
      ...
      <div className="mb-4 bg-pink-50 p-4">
      ...
      <div>
        <button
          className="bg-pink-700 hover:bg-pink-800 text-white font-bold py-2 px-4 rounded-full w-full focus:outline-none focus:shadow-outline"
          type="submit"
        >
          Add Property
        </button>
